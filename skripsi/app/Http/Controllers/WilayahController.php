...
class WilayahController extends Controller
{
    ...
    //     return view('dashboard.visualisasi.wilayah' , ['divisi' =>$divisi , 'pasar' => $pasar , 'pabrik'=>$pabrik , 'agri'=>$agri ,
    //         'itemRequest' => $itemRequest , 'nonItemRequest'=>$nonItemRequest , 'divisiAll' => $divisiAll , 
    ...
    //     $nonFoodRequest = count($kecamatan->nonFoodRequest);
    //     return view('dashboard.visualisasi.wilayah' , ['kecamatan' =>$kecamatan , 'pasar' => $pasar , 'pabrik'=>$pabrik , 'agri'=>$agri ,
    //         'foodRequest' => $foodRequest , 'nonFoodRequest'=>$nonFoodRequest , 'kecamatanAll' => $kecamatanAll , 
    //         // 'provinsi' => $provinsi ,'kota' => $kota
    //     ]);

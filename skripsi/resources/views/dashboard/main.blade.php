    ...
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link" href="{{route('admin.NonItemRequestIndex')}}">
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © PT Pindad Enjiniring Indonesia 2023</span>
                    </div>
                </footer>
            </div>
            <!-- main-panel ends -->
